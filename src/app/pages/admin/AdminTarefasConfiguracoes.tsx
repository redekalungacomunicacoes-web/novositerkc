    ...
    <TasksPageShell>
      <main className="rounded-3xl border border-emerald-100 bg-white p-8 shadow-sm dark:border-emerald-800/60 dark:bg-emerald-950/70">
          <div className="flex items-center gap-3 text-emerald-700 dark:text-emerald-300">
            <Settings size={22} />
            <span className="text-sm font-medium uppercase tracking-[0.2em]">Configurações</span>
          </div>
          <h1 className="mt-4 text-2xl font-semibold text-slate-950 dark:text-white">Configurações de tarefas</h1>
