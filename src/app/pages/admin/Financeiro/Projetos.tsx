            ...
            <div className="p-6">
              ...
              <div className="mb-6">
                ...
                <p className="text-3xl font-bold text-[#0f3d2e]">
                  {formatCurrency(projeto.saldoDisponivel)}
                </p>
              </div>
              ...
              <div className="mb-6">
                <div className="flex items-center justify-between mb-2">
                  ...
                  <span className="text-sm font-medium text-gray-900">{projeto.execucao}%</span>
                </div>
                <div className="relative w-full h-2 bg-gray-100 rounded-full overflow-hidden">
                  <div
                    className="absolute top-0 left-0 h-full bg-[#0f3d2e] rounded-full transition-all"
                    style={{ width: `${projeto.execucao}%` }}
                  />
                </div>
              </div>
              ...
              <div className="grid grid-cols-3 gap-3 mb-6">
                ...
                <div>
                  ...
                  <p className="text-sm font-semibold text-gray-900">
                    {formatCurrency(projeto.gastoReal)}
                  </p>
                </div>
                <div>
              ...
              <div className="flex gap-3">
                <Link
                  to={`/admin/financeiro/projeto/${projeto.id}`}
