...
export function FundoDetalhes() {
  ...
  const metrics = useMemo(() => {
    ...
    const withAttachments = movimentacoesFundo.filter((m) => m.comprovantes.length > 0).length;
    const withoutAttachments = movimentacoesFundo.length - withAttachments;
    return {
